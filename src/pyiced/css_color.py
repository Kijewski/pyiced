...
from ._pyiced import Color as _Color
...
'''.splitlines():
    _name, _r, _g, _b = _line.split()
    _r = int(_r) / 255
    _g = int(_g) / 255
    _b = int(_b) / 255
    exec(f'{_name} = _Color({_r!r}, {_g!r}, {_b!r})')
    exec(f'__all__.append({_name!r})')

del _Color, _line, _name, _r, _g, _b
